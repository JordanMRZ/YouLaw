...
<template>
  ...
  <section class="stats-strip"><article class="stat-item"><span class="stat-icon coral-icon">♨</span><div><strong>5 días</strong><small>Racha actual</small></div></article><article class="stat-item"><span class="stat-icon blue-icon">✦</span><div><strong>{{ totalXp }} XP</strong><small>Experiencia total</small></div></article><article class="stat-item lives-stat"><span class="stat-icon coral-icon">♥</span><div><strong>{{ lives }}/{{ maxLives }}</strong><small>Vidas</small></div></article><article class="stat-item"><span class="stat-icon yellow-icon">◆</span><div><strong>3 logros</strong><small>Desbloqueados</small></div></article></section>
